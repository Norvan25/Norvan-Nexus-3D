...
export default function InputPill() {
  ...
  return createPortal(
    <motion.div
      ...
      className="fixed bottom-[calc(2rem+env(safe-area-inset-bottom))] md:bottom-8 left-1/2 transform -translate-x-1/2 w-[90%] max-w-[600px] h-14 z-[9999] flex items-center justify-between px-4 bg-[#0D1326]/80 backdrop-blur-xl rounded-full border border-white/10 shadow-[0_4px_20px_rgba(0,192,255,0.2)]"
    >
      {/* Plus Button */}
